...
#ifndef SharedFdPipe_h
#define SharedFdPipe_h

#include "OMX_Core.h"
#include "OMX_ContentPipe.h"

/** The OMX_SFD_PIPE_API is platform specific definitions used
 *  to declare OMX function prototypes.  They are modified to meet the
 *  requirements for a particular platform */
#ifdef __WINCE_DLL
#   ifdef __OMX_SFD_PIPE_EXPORTS
#       define OMX_SFD_PIPE_API __declspec(dllexport)
#   else
#       define OMX_SFD_PIPE_API __declspec(dllimport)
#   endif
#else
#   ifdef __OMX_SFD_PIPE_EXPORTS
#       define OMX_SFD_PIPE_API
#   else
#       define OMX_SFD_PIPE_API extern
#   endif
#endif
