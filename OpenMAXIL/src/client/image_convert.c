...
JPEG_ENC_YUV_FORMAT jpeg_enc_color_format(OMX_COLOR_FORMATTYPE eColorFormat)
{
	...
	{
	case OMX_COLOR_FormatYUV420Planar:
		ret_format = JPEG_ENC_YUV_420_NONINTERLEAVED;
		break;
	case OMX_COLOR_FormatYUV422Planar:
		ret_format = JPEG_ENC_YU_YV_422_INTERLEAVED;
		break;
	case OMX_COLOR_FormatYCbYCr:
		ret_format = JPEG_ENC_YU_YV_422_INTERLEAVED;
		break;
	case OMX_COLOR_FormatYCrYCb:
		ret_format = JPEG_ENC_YV_YU_422_INTERLEAVED;
		break;
	case OMX_COLOR_FormatCbYCrY:
		ret_format = JPEG_ENC_UY_VY_422_INTERLEAVED;
		break;
	case OMX_COLOR_FormatCrYCbY:
		ret_format = JPEG_ENC_VY_UY_422_INTERLEAVED;
		break;
	case OMX_COLOR_FormatYUV444Interleaved:
		ret_format = JPEG_ENC_YUV_444_NONINTERLEAVED;
		break;	 // TODO: no 444 noninterleaved in omx
	case OMX_COLOR_FormatYUV422PackedPlanar:
	case OMX_COLOR_FormatYUV422SemiPlanar:
	case OMX_COLOR_FormatYUV411Planar:
	case  OMX_COLOR_FormatYUV420PackedPlanar:
