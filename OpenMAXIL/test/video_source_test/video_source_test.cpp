...
static void MakeDumpFileName(char *media_file_name,
        char *dump_file_path,int port_num)
{
        ...
        OMX_STRING dump_file)
{
    ...
    MakeDumpFileName(dump_file,hTest->dump_file_path0,0);
    MakeDumpFileName(dump_file,hTest->dump_file_path1,1);
